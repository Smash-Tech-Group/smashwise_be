...
Application configuration — reads from .env via python-decouple.

New keys added for this issue:
  PAYSTACK_SECRET_KEY   — used to sign API requests and verify webhooks
  PAYSTACK_BASE_URL     — override in tests / staging
"""
...
class Settings(BaseSettings):
    ...
    # ── Paystack (added for cart-checkout-backend) ──────────────
    PAYSTACK_SECRET_KEY: str = config("PAYSTACK_SECRET_KEY", default="")
    PAYSTACK_BASE_URL:   str = config("PAYSTACK_BASE_URL", default="https://api.paystack.co")
